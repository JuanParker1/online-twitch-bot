...
class CreateForm extends Form {
    constructor(){
        ...
        this.fields = {
            name: new class extends FormField.TextAttribute { constructor(){ super(); this.sequence = ''; this.attribute = new OTB_DefaultCommandCategory().attributes.name; this.width = '12'; this.offset = '0'; this.getFocus = false;} }()
        };
