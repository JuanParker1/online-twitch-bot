// OTB_DomainYoutubeVideo Controllers
// 
...
import * as Form from '../form/OTB_DomainYoutubeVideo';
       ...
       if (formData) {
           switch(formData.action) {
               case 'save':
                   ...
                   DomainAPI.OTB_DomainYoutubeVideoCreate(formData.values, contextObject.user);
                   break;
           }
       }
   });
...
var UpdateController = function(contextObject) {
           ...
           if (formData) {
               switch(formData.action) {
                   case 'save':
                       ...
                       DomainAPI.OTB_DomainYoutubeVideoUpdate(loadedEntity, formData.values, user);
                       break;
                   case 'delete':
                       DomainAPI.OTB_DomainYoutubeVideoDelete(loadedEntity, user);
                       break;
               }
           }
       });
   ...
   if (entity.loadStatus === 'proxy') {
       entity.loadInstance(OTB_DomainYoutubeVideo, entity.id, function(loadedEntity) {
