...
class CreateForm extends Form {
   constructor(){
       super();
       this.name = 'OTB_UserCreateForm';
       this.title = 'User toevoegen';
       this.fields = {
...
class UpdateForm extends Form {
   constructor(){
       super();
       this.name = 'OTB_UserUpdateForm';
       this.title = 'User wijzigen';
       this.fields = {
...
class SelectForm extends Form {
   constructor(){
       super();
       this.name = 'OTB_UserSelectForm';
       this.title = 'User selecteren';
       this.fields = {
