...
class CreateForm extends Form {
   constructor(){
       super();
       this.name = 'OTB_PointParticipationCreateForm';
       this.title = 'OTB_PointParticipation toevoegen';
       this.fields = {
...
class UpdateForm extends Form {
   constructor(){
       super();
       this.name = 'OTB_PointParticipationUpdateForm';
       this.title = 'OTB_PointParticipation wijzigen';
       this.fields = {
...
class SelectForm extends Form {
   constructor(){
       super();
       this.name = 'OTB_PointParticipationSelectForm';
       this.title = 'OTB_PointParticipation selecteren';
       this.fields = {
