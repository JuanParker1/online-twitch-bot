...
class CreateForm extends Form {
   constructor(){
       super();
       this.name = 'OTB_QueueVideoCreateForm';
       this.title = 'OTB_QueueVideo toevoegen';
       this.fields = {
...
class UpdateForm extends Form {
   constructor(){
       super();
       this.name = 'OTB_QueueVideoUpdateForm';
       this.title = 'OTB_QueueVideo wijzigen';
       this.fields = {
...
class SelectForm extends Form {
   constructor(){
       super();
       this.name = 'OTB_QueueVideoSelectForm';
       this.title = 'OTB_QueueVideo selecteren';
       this.fields = {
