...
class CreateForm extends Form {
   constructor(){
       super();
       this.name = 'OTB_HistoryVideoCreateForm';
       this.title = 'OTB_HistoryVideo toevoegen';
       this.fields = {
...
class UpdateForm extends Form {
   constructor(){
       super();
       this.name = 'OTB_HistoryVideoUpdateForm';
       this.title = 'OTB_HistoryVideo wijzigen';
       this.fields = {
...
class SelectForm extends Form {
   constructor(){
       super();
       this.name = 'OTB_HistoryVideoSelectForm';
       this.title = 'OTB_HistoryVideo selecteren';
       this.fields = {
