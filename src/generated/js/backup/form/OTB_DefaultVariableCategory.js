// OTB_DefaultVariableCategory Forms
// 
...
class CreateForm extends Form {
   constructor(){
       super();
       this.name = 'OTB_DefaultVariableCategoryCreateForm';
       this.title = 'OTB_DefaultVariableCategory toevoegen';
       this.fields = {
           name: new class extends FormField.Text { constructor(){ super(); this.sequence = ''; this.attribute = new OTB_DefaultVariableCategory().attributes.name; this.width = '12'; this.offset = '0'; this.getFocus = false;} }()
       }
...
class UpdateForm extends Form {
   constructor(){
       super();
       this.name = 'OTB_DefaultVariableCategoryUpdateForm';
       this.title = 'OTB_DefaultVariableCategory wijzigen';
       this.fields = {
           name: new class extends FormField.Text { constructor(){ super(); this.sequence = ''; this.attribute = new OTB_DefaultVariableCategory().attributes.name; this.width = '12'; this.offset = '0'; this.getFocus = false;} }()
       }
   };
...
class SelectForm extends Form {
   constructor(){
       super();
       this.name = 'OTB_DefaultVariableCategorySelectForm';
       this.title = 'OTB_DefaultVariableCategory selecteren';
       this.fields = {
