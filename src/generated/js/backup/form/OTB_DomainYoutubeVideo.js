...
class CreateForm extends Form {
   constructor(){
       super();
       this.name = 'OTB_DomainYoutubeVideoCreateForm';
       this.title = 'OTB_DomainYoutubeVideo toevoegen';
       this.fields = {
...
class UpdateForm extends Form {
   constructor(){
       super();
       this.name = 'OTB_DomainYoutubeVideoUpdateForm';
       this.title = 'OTB_DomainYoutubeVideo wijzigen';
       this.fields = {
...
class SelectForm extends Form {
   constructor(){
       super();
       this.name = 'OTB_DomainYoutubeVideoSelectForm';
       this.title = 'OTB_DomainYoutubeVideo selecteren';
       this.fields = {
