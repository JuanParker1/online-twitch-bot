...
class CreateForm extends Form {
   constructor(){
       ...
       this.fields = {
           name: new class extends FormField.Text { constructor(){ super(); this.sequence = ''; this.attribute = new OTB_DefaultCommand().attributes.name; this.width = '12'; this.offset = '0'; this.getFocus = false;} }(),
           description: new class extends FormField.LongText { constructor(){ super(); this.sequence = ''; this.attribute = new OTB_DefaultCommand().attributes.description; this.width = '12'; this.offset = '0'; this.getFocus = false;} }(),
           handler: new class extends FormField.Text { constructor(){ super(); this.sequence = ''; this.attribute = new OTB_DefaultCommand().attributes.handler; this.width = '12'; this.offset = '0'; this.getFocus = false;} }()
       }
...
class UpdateForm extends Form {
   constructor(){
       super();
       this.name = 'OTB_DefaultCommandUpdateForm';
