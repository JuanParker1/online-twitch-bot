...
class CreateForm extends Form {
   constructor(){
       super();
       this.name = 'OTB_ApplicationCreateForm';
       this.title = 'Application toevoegen';
       this.fields = {
...
class UpdateForm extends Form {
   constructor(){
       super();
       this.name = 'OTB_ApplicationUpdateForm';
       this.title = 'Application wijzigen';
       this.fields = {
...
class SelectForm extends Form {
   constructor(){
       super();
       this.name = 'OTB_ApplicationSelectForm';
       this.title = 'Application selecteren';
       this.fields = {
