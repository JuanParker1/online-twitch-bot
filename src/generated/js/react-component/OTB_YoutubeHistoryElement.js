// OTB_YoutubeHistoryElement React Component
//
...
class OTB_YoutubeHistoryElement extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
            data: {}
                    ...
                    <div className="grid">
                        <div className="row cells3">
                            ...
                            <div className="cell colspan2">
                                ...
                                <p>Added: {self.props.videoObj.get('addedTime')}</p>
                                <p>Played: {self.props.videoObj.get('timestampCreate')}</p>
                            </div>
                        </div>
                    </div>
                </div>
...
export default OTB_YoutubeHistoryElement;
