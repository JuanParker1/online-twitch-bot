// OTB_LevelParticipation Controllers
// 
...
import * as Form from '../form/OTB_LevelParticipation';
        ...
        if (formData) {
            switch(formData.action) {
                case 'save':
                    ...
                    if (contextObject['levelParticipators']) {
                        formData.values['levelParticipators'] = contextObject['levelParticipators'];
                    }
                    if (contextObject['ownLevels']) {
                        formData.values['ownLevels'] = contextObject['ownLevels'];
                    }                    
DomainAPI.OTB_LevelParticipationCreate(formData.values, contextObject.user);
                    break;
            }
        }
    });
...
var UpdateController = function(contextObject) {
            ...
            if (formData) {
                switch(formData.action) {
                    case 'save':
                        ...
                        DomainAPI.OTB_LevelParticipationUpdate(loadedEntity, formData.values, user);
                        break;
                    case 'delete':
                        DomainAPI.OTB_LevelParticipationDelete(loadedEntity, user);
                        break;
                }
            }
        });
    ...
    if (entity.loadStatus === 'proxy') {
        entity.loadInstance(OTB_LevelParticipation, entity.id, function(loadedEntity) {
